...
public class Application {
	...
	public static void main(String[] args) {
		...
		CouponDao couponJpaDao = container.getBean("couponJpaDaoImpl", CouponDao.class);
//		CouponDao couponJdbcDao = container.getBean(CouponDao.class);
		couponJpaDao.saveCoupon(coupon);
	}
